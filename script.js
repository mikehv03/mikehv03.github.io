...
const penaltyQuestions = {
  itam: [
    { question: "What does ITAM Miguel study?", answers: ["Finance and Data Science", "Economics and Statistics", "Finance and Actuarial Science", "Business Analytics and Economics"], correct: 0 },
    { question: "Which class shaped ITAM Miguel the most?", answers: ["Corporate Finance", "Investments", "Econometrics", "Financial Accounting"], correct: 0 },
    { question: "Which technical topic was especially challenging?", answers: ["Mathematical Statistics", "Stochastic Processes", "Econometrics", "Linear Optimization"], correct: 0 },
    { question: "Which subject feels most natural to him?", answers: ["Algorithms and Programming", "Data Visualization", "Macroeconomics", "Probability Theory"], correct: 0 },
    { question: "What academic achievement makes him proud?", answers: ["Studying two degrees", "Completing an international exchange", "Leading academic projects", "Maintaining consistent academic performance"], correct: 0 },
  ],
  uber: [
    { question: "Where does Uber Miguel currently work?", answers: ["Uber", "DiDi", "Cabify", "Rappi"], correct: 0 },
    { question: "When did Miguel join Uber?", answers: ["March 2026", "January 2026", "July 2025", "September 2025"], correct: 0 },
    { question: "Which team is Uber Miguel part of?", answers: ["Strategy & Planning Mobility Mexico", "Marketplace Operations LATAM", "Mobility Expansion Mexico", "Rider Growth Strategy"], correct: 0 },
    { question: "What kind of work does he enjoy at Uber?", answers: ["High-impact problems with limited information", "Long-term operational planning", "User acquisition optimization", "Marketplace balancing"], correct: 0 },
    { question: "Which skill improved the most at Uber?", answers: ["Communication", "Cross-functional collaboration", "Analytical storytelling", "Decision-making speed"], correct: 0 },
  ],
  incode: [
    { question: "What type of work did Incode Miguel do?", answers: ["M&A and market research", "Product growth analysis", "Startup financial modeling", "Strategic consulting research"], correct: 0 },
    { question: "What interested him about M&A?", answers: ["Business expansion opportunities", "Market positioning", "Revenue optimization", "International scaling"], correct: 0 },
    { question: "What makes a company interesting to him?", answers: ["Innovative new products", "Scalable business models", "Market differentiation", "Strong competitive positioning"], correct: 0 },
    { question: "What does he enjoy connecting?", answers: ["Businesses and potential synergies", "Teams and operational structures", "Markets and customer behavior", "Products and distribution channels"], correct: 0 },
    { question: "What did he help build?", answers: ["A structured M&A pipeline", "A target-company scorecard", "A market-mapping tracker", "A strategic research deck"], correct: 0 },
  ],
  miguel: [
    { question: "Which team does Miguel support in Mexico?", answers: ["Pumas UNAM", "Cruz Azul", "Toluca", "Tigres"], correct: 0 },
    { question: "Which European team does Miguel support?", answers: ["FC Barcelona", "Arsenal", "Manchester City", "AC Milan"], correct: 0 },
    { question: "What is Miguel surprisingly bad at?", answers: ["Cooking", "Baking desserts", "Meal prepping", "Making breakfast"], correct: 0 },
    { question: "Who is Miguel's favorite current Barça player?", answers: ["Pedri", "Gavi", "Lamine Yamal", "Frenkie de Jong"], correct: 0 },
    { question: "What was Miguel's favorite Pumas memory?", answers: ["2011 Liga MX Final, Pumas champion", "A dramatic Clásico Capitalino win", "A last-minute Liguilla comeback", "A home victory at Olímpico Universitario"], correct: 0 },
    { question: "Who is Miguel's favorite artist?", answers: ["Álvaro Díaz", "Feid", "Mora", "Rauw Alejandro"], correct: 0 },
  ],
};
